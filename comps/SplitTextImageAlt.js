const SectionIntroAlt = props => {
    return (
        <div className="p-4 flex flex-col-reverse lg:flex-row justify-between items-center max-w-7xl m-auto">
            <div className="w-full lg:w-3/6 bg-white">
                <div className="portfolio-image-container"><center><img className="portfolio-image2 rounded-md shadow-2xl" src={props.image}></img></center></div>
            </div>
