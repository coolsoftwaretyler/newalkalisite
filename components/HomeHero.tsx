  ...
  return <div className="bg-alkaligrey-200 home-hero-bg">
    ...
    <div className="justify-between max-w-7xl justify-center m-auto">
      <span>
        ...
        />
        <Link href="/#services"><a href="" className="p-4 shadow-2xl px-12 font-semibold ml-5 text-text-alkaligrey-600 mt-48 border border-alkaligrey-600 rounded-md transition duration-500 ease-in-out hover:bg-alkaligrey-600 hover:text-white transform hover:-translate-y-1 hover:scale-110">View Services</a></Link>
      </span>
    </div>
