...
export default class OldSimpleSlider extends Component<SimpleSliderProps> {
  render() {
    const settings = {
      infinite: true,
      speed: 500,
                  ...
                  <div className="relative lg:w-7/12 bg-white">
                    ...
                    <div className="relative py-12 lg:py-24 px-8 lg:px-16 text-gray-700 leading-relaxed">
                      ...
                      <p className="mt-3 font-open font-bold">
                        {this.props.name1}</p>
                      <p className="mt-6">
                        <a href="#" className="font-medium font-open duration-500 text-black hover:text-alkali-500">{`Learn more about ${this.props.company}'s`}  project &rarr;</a>
                      </p>
                    </div>
                  </div>
                </div>
