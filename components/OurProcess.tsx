...
const OurProcess = props => {
    return (
        <div className="mb-16 md:mb-36">
            <div className={`flex flex-col ${props.type % 2 === 0 ? 'md:flex-row-reverse' : 'md:flex-row'} relative self-center max-w-5xl mx-14 lg:m-auto shadow-2xl md:shadow-none`}>
                <div className={`${props.type % 2 === 0 ? 'event-dotR ml-0 md:ml-7' : 'event-dotL ml-0 md:mr-7'}  bg-alkali-500 text-center rounded-none md:rounded-full w-auto h-auto md:w-20 md:h-20 self-stretch md:self-center p-6 shadow-2xl rounded-t-md md:rounded-none`}>
